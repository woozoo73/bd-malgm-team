...
* [TensorFlow : GET STARTED 한글](https://tensorflowkorea.gitbooks.io/tensorflow-kr/content/g3doc/get_started/)
...
## Chatbot
* [챗봇은 앱을 대체할까](https://brunch.co.kr/@gentlepie/6)
* [카카오톡 플러스친구](https://center-pf.kakao.com/login)
* [카카오톡 플러스친구 API v. 2.0 개요](https://github.com/plusfriend/auto_reply)
* [Facebook Messenger 플랫폼](https://developers.facebook.com/docs/messenger-platform)
* [Chatbot 기술 검토](https://docs.google.com/presentation/d/1nTzFcb6x7oHh3b28E5PYhU_m0sbRCan0l11l9Y0DScA/edit#slide=id.p)
* [MS Bot Framework](https://docs.microsoft.com/en-us/bot-framework/nodejs/bot-builder-nodejs-overview)
* [IBM Watson Conversation](https://www.youtube.com/watch?v=lnr4-fZ5chY)
* [fluenty.ai](https://www.fluenty.ai/)
* [</> Malgm](https://drive.google.com/drive/u/0/my-drive)
# Cloud
## PaaS
...
* [TDD 짝 프로그래밍 실습 후 체크리스트](http://blog.doortts.com/144)
* [감사주도개발 TDD (Thanks Driven Development)](http://blog.doortts.com/157)
## Code Review
